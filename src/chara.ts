...
class Chara {
    ...
    constructor (arr: any[]) {
        ...
        this.rare = arr[7]*1
        this.prop = arr[8]*1
        this.skillID = arr[13+3]*1
        this.hp = arr[16+3]*1
        this.ev2 = arr[33+3]*1
        this.isEv2 = arr[34+3]*1
        this.isKnight = arr[35+3]*1
        this.ref = arr[39+3]*1
        this.evo = arr[40+3]*1
        this.ev3 = arr[46+3]*1
        this.isEv3 = arr[47+3]*1
        this.canEv3 = arr[48+3]*1
        this.name = arr[49+3]
        this.noCG = arr[50+3]*1
        this.kana = arr[52+3]
        this.isEvent = arr[55+3]*1
        this.createDate = arr[56+3]
        this.ev4 = arr[60+3]*1
        this.isEv4 = arr[61+3]*1
        this.canEv4 = arr[62+3]*1
